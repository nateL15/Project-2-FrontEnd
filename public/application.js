...
var notes = __webpack_require__(16);
...
var hideNoteForms = function hideNoteForms() {
  $('#change-password').hide();
  $('#sign-out').hide();
  $('#save-note').hide();
  $('#get-note').hide();
...
var clearNoteForms = function clearNoteForms() {
...
var signOutSuccesss = function signOutSuccesss(data) {
  console.log(data);
...
module.exports = {
  ...
  signOutSuccesss: signOutSuccesss,
...
var onSaveNote = function onSaveNote(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.saveNote(data).then(ui.saveNoteSuccess).catch(ui.saveNoteFailure);
};

var onGetNote = function onGetNote(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.getNote(data).then(ui.getNoteSuccess).catch(ui.getNoteFailure);
};

var onDeleteNote = function onDeleteNote(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.deleteNote(data).then(ui.deleteNoteSuccess).catch(ui.deleteNoteFailure);
};

var onUpdateNote = function onUpdateNote(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.updateNote(data).then(ui.updateNoteSuccess).catch(ui.updateNoteFailure);
};

var clearNoteForm = function clearNoteForm() {
  $('#save-note').trigger('reset');
  $('#get-note').trigger('reset');
...
var hideNoteForm = function hideNoteForm() {
  $('#update-note').hide();
  $('#get-note').hide();
  $('#delete-note').hide();
  $('#save-note').hide();
...
var saveNote = function saveNote(info) {
  return $.ajax({
...
var updateNote = function updateNote(data) {
  return $.ajax({
...
var getNote = function getNote(data) {
  return $.ajax({
    url: config.apiOrigin + '/notes/',
    method: 'GET',
    headers: {
...
var deleteNote = function deleteNote(data) {
  return $.ajax({
    url: config.apiOrigin + '/notes/' + data.note.id,
    method: 'DELETE',
    headers: {
...
var showNotes = __webpack_require__(19);

var saveNoteSuccess = function saveNoteSuccess(data) {
  $('#message').text('Champion note created succesfully!');
};

var saveNoteFailure = function saveNoteFailure(error) {
  $('#message').text('Error Saving Note', error);
};

var getNoteSuccess = function getNoteSuccess(data) {
  var onShowNotes = showNotes({ notes: data.notes });
  $('.display-notes').empty();
...
var deleteNoteSuccess = function deleteNoteSuccess(data) {
  $('#message').text('Note deleted successfully!');
};

var deleteNoteFailure = function deleteNoteFailure(data) {
  $('#message').text('Unable to delete note');
};

var updateNoteSuccess = function updateNoteSuccess(data) {
  $('#message').text('Note succesfully updated!');
};

var updateNoteFailure = function updateNoteFailure(data) {
  $('#message').text('Unable to update note');
};

module.exports = {
  saveNoteSuccess: saveNoteSuccess,
  saveNoteFailure: saveNoteFailure,
  getNoteSuccess: getNoteSuccess,
  getNoteFailure: getNoteFailure,
  showNotes: showNotes,
  deleteNoteSuccess: deleteNoteSuccess,
  deleteNoteFailure: deleteNoteFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <ul data-id=\""
    ...
    + "\">\n  <li>"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.note : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n    <li>"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.champion : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(8, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n      <li>"
    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.id : stack1),{"name":"if","hash":{},"fn":container.program(10, data, 0, blockParams),"inverse":container.program(12, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "</li>\n\n  </ul>\n";
  ...
  return "\n      <large>Champion: "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.champion : stack1), depth0))
    + "</large>\n";
